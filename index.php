...
<body style="background-image: url('assets/img/background.png');">
  ...
  <!-- Header -->
    ...
    <div class="wrapper">
          ...
          <h2 style="font-family: 'Bad Script', Sans-serif; font-size: 20px; color: dimgray; font-weight: bolder; text-decoration-line: underline; text-decoration-style: wavy; margin-top: -20px"><span class="txt-rotate" data-period="1000" data-rotate='["Computer science student", "Software Engineer", "Web dev"]'></span></h2>
            ...
            <ul class="pure-menu-list">
              <li class="pure-menu-item header-active"><a href="index.html" class="pure-menu-link">Home</a></li>
...
I completed my diploma from government polytechnic, Masabtank in 2019 with a degree in Computer science and engineering.</p>
      ...
      <!-- Banaao -->
    	<div class="tab">
    		...
    		<label for="tab5" class="tab-label">Software Intern - Pixel Quest solutions</label>
    		<div class="tab-content">
    			Nov 2018 - Mar 2019
    			<ul>
      			<li>Me along with a team of 5 people were assigned a python based project on which we worked for 5 months.</li>
            <li>Tried several python libraries and learnt to integrate third party APIs into code. </ul>
	      </div>
      </div>
  </div>
<?php ?>
