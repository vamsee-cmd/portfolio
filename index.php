...
<button type="button" class="btn btn-outline-primary" id="connect">Know my work</button>
<br/><br/><br/><br/>
...
<form method="post" action="./db/conn.php">
  ...
  <div class="mb-3">
    ...
    <input type="tel" name="mobile" class="form-control" id="exampleInputPassword1" pattern="[6-9]{1}[0-9]{9}">
  </div>
